console.log("This messaage will show up in the Chrome console if everything is working correctly.")
/*
Exercise 1:
...
//two instances of forEach method; looping through at top level: go thru numArrays; then go thru num

numArrays.forEach(function(el, idx){
    console.log("element in the array", idx, el)

    el.forEach(function(gnome){
        console.log("gnome in the array tree", gnome)
